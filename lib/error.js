...
<head>
  ...
  <link rel="shortcut icon" href="https://cdn.jsdelivr.net/npm/passerve@1.0.0/dist/favicon.ico" type="image/x-icon" />
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" />
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/water.css@2/out/water.css" data-style="water" />
  <style>
    body {
      font-size: 1rem;
      line-height: 1.5;
...
<body>
  <main class="err">
    <div>
      <h1><i class="bi bi-bell"></i> Error 404!</h1>
      <p>Page not found!</p>
  ...
  <script>
    // color-switch
    // the script for the dual dark-light color theme switch

    const linkElm = document.querySelector('link[data-style="water"]')
    if (!linkElm) {
      throw new Error("!!! The link stylesheet water.css with data-style='water' was not found !!!")
    }
    ...
    const buttonSwicher = document.querySelector('.color-switcher button') // take the switch node
    if (!buttonSwicher) {
      throw new Error('!!! The color theme switch with the .color-switcher class was not found !!!')
    }

    let [light, dark] = buttonSwicher.children // take the switch subnodes
